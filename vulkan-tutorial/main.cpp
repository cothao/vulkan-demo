...
private:
    ...
    static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
        ...
        void* pUserData)
    {
        std::cerr << "validiation layer: " << pCallbackData->pMessage << std::endl;
        return VK_FALSE;
    }
    ...
    void createGraphicsPipeline()
    {
        ...
        colorBlendAttachment.colorWriteMask = // Coloblend attachment configuations per framebuffer
        ...
        VkPipelineColorBlendStateCreateInfo colorBlending{}; // colorblend settings
